                ...
                {/* <div className="dashboard-list-container">
                    ...
                    <div className="white-bg">
                        ...
                        <div className="schedule-filters"> 
                            <Select name='demo' title="Season" hiddenValue='Select Season' listOfSelects={selectData} onChange={(e) => console.log(e.target.value,'changed!')}/>
                            <Select name='demo' title="Division" listOfSelects={[{name: 'All', value: ''}, ...selectData]} onChange={(e) => console.log(e.target.value,'changed!')}/>
                            <Select name='demo' title="Team"     listOfSelects={[{name: 'All', value: ''}, ...selectData]} onChange={(e) => console.log(e.target.value,'changed!')}/>
                            <a>Clear Filters</a>
